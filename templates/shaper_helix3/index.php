...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
    <head>
        ...
        <?php
            ...
            $this->helix3->addCSS('font-awesome.min.css,materialize.css,mae_bootstrapv4.css,mae_slick.css,mae_style.css,mae_responsive.css,custom-images.css') // CSS Files
                ->addJS('bootstrapv4.min.js,jquery.sticky.js,main.js,materialize.js,jquery.lazy.min.js,jquery.lazy.plugins.min.js,parallax.min.js,slick.min.js,mae_scripts.js') // JS Files
            ...
            $this->helix3->addCSS('/administrator/templates/esan/videopopup/video.popup.css');
            $this->helix3->addJS('/administrator/templates/esan/videopopup/video.popup.js');

            $this->helix3->addJS('bootstrap.bundle.min.js','text/javascript"  defer="false" async="true'); // JS Files - #001-CCC
    ...
    <body data-spy="scroll" class="<?php echo $this->helix3->bodyClass($body_classes); ?> off-canvas-menu-init">
