(function (win, doc, EL) {
	...
	win.EsanSuscribeFormBottom = EsanSuscribeFormBottom;

	win.addEventListener('DOMContentLoaded', function () {
		var form = $('form.esan-suscribe-form-bottom');

		if (form) {
			EsanSuscribeFormBottom.initialize(form);
		}
	});
