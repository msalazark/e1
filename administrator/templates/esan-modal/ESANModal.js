(function (win, doc) {
	...
	Object.assign(ESANModal.prototype, {
		...
		setContent: function (content) {
			this.dom.content.$adopt(
				content.$dispose().$remAttr('data-esanmodal')
			);
		},
	...
	ESANModal.modal = function (event) {
		...
		var modal_id = this.getAttribute('data-esanmodal-target');
		var target   = $('[data-esanmodal="' + modal_id + '"]');
	...
	ESANModal.scan = function () {
		$$('[data-esanmodal-target]').forEach(function (el) {
