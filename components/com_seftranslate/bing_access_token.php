...
/*$fp = fopen('data.txt', 'a+');
fwrite($fp, "<br />".$_REQUEST["oncomplete"] );
fclose($fp);
...
// -H "Ocp-Apim-Subscription-Key: {441a8e36-0452-4619-8f77-75b4330db7a9}"
...
//          $authUrl = "https://api.cognitive.microsoft.com/sts/v1.0/issueToken";
        ...
        // print_r($authUrl);
        // print_r(":33333333333:");
        // print_r($SubscriptionKey);        
        // print_r(":44444444444444444:");
...
try {
  ...
  if($_SESSION['expire_last'] != 0 && $expire - $_SESSION['expire_last'] < 9*60 && isset($_SESSION['access_token']) ){
    print_r($_SESSION['access_token']) ;
    exit;
  }

  // //Client ID of the application.
  // $clientID       = $seftranslate_configuration['api_bing_client_id']; //3333333333333333

  // //Client Secret key of the application.
  // $clientSecret       = $seftranslate_configuration['api_bing_client_secret']; //GwnH0PCaH50raIYRvGQw6tW7vsdojddUpnZcX0b46GA=
  // //OAuth Url.
  ...
  //Get the Access token.
//  $accessToken  = $authObj->getTokensCurlRequest_old($grantType, $scopeUrl, $clientID, $clientSecret, $authUrl);
...
//  $authUrl      = "https://api.cognitive.microsoft.com/sts/v1.0/issueToken";
//  $authUrl      = "https://westeurope.api.cognitive.microsoft.com/sts/v1.0/issueToken";
  

// curl --header 'Ocp-Apim-Subscription-Key: 4835480fa0b340b7ab27ece84aa41aa9' --data "" 'https://westeurope.api.cognitive.microsoft.com/sts/v1.0/issueToken'


  $accessToken  = $authObj->getTokensCurlRequest($authUrl,$host, $SubscriptionKey);
