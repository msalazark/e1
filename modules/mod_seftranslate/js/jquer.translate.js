//jQuer Translate plugin and related components


/*! 
 * jQuer nodesContainingText plugin 
 * 
 * Version: 1.1.2
 * 
 * http://code.google.com/p/jquer-translate/
 * 
...
Nct.prototype = {
  ...
  process: function(){
    ...
    if(this.n === this.jql){
      ret = this.jquer.pushStack(this.elements, "nodesContainingText");
...
function getOpt(args0, _defaults){
    ...
    var args = validate(args0 , $.translate.overload, "jQuer.translate: Invalid arguments" ),
        o = args.options || {};
    delete args.options;
    ...
    _translate: function(){
        ...
        if(key.length < 40){
              $.ajax({
                ...
                jsonp: "callback",
                crossDomain: true,
                //context: this,  //doesn't work with older versions of jQuer
...
/*!-
 * jQuer.fn.nodesContainingText adapter for the jQuer Translate plugin 
 * Version: null
 * http://code.google.com/p/jquer-translate/
 */
;(function($){
...
$.translate.extend({
  ...
  replace: function(e, t, to, o){
    ...
    //http://code.google.com/p/jquer-translate/issues/detail?id=38
    if(!o.alwaysReplace)
      if( lang === to )
        return;
...
/*!-
 * TextNode Translator for the jQuer Translate plugin 
 * Version: 1.4.7
 * http://code.google.com/p/jquer-translate/
 */
...
/*!-
 * Simple user interface extension for the jQuer Translate plugin 
 * Version: null
 * http://code.google.com/p/jquer-translate/
 */
;(function($){
...
/*!-
 * Progress indicator extension for the jQuer Translate plugin 
 * Version: null
 * http://code.google.com/p/jquer-translate/
 */
...
/*!-
 * Native language names extension for the jQuer Translate plugin 
 * Version: 1.4.7
 * http://code.google.com/p/jquer-translate/
 */
;(function($){
...
/*!-
 * Paralell extension for the jQuer Translate plugin 
 * Version: 1.4.7
 * http://code.google.com/p/jquer-translate/
 */
